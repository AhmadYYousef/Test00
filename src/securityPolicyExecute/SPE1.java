...
public class SPE1 {
	 ...
	 public static void main(String[] args){
		...
		//	System.out.print("Test");
	        ...
	        String subjectId ="C70001";

	        String subjectName ="Alise Ibrahem";

	        String subjectDep ="IT";

	        String subjectJob ="Employee";

	        String subjectMAC ="20C3D4E8F1D2";
	        String subjectMB ="DDEEFF0011AABBCC";
	        String subjectCPU ="CCBBAA99FFEEDD"; 
	       ...
	       // initData();
	        ...
	        String request = createXACMLRequest( subjectId,subjectName , subjectDep, subjectJob, subjectMAC,subjectMB, subjectCPU,resource);
	 ...
	 //////////////////////getPDPNewInstance
	 public static String createXACMLRequest( String userID, String userName, String subjectDep , String subjectJob , String subjectMAC , String subjectMB , String subjectCPU , String resource){
		        ...
		        return "<Request xmlns=\"urn:oasis:names:tc:xacml:3.0:core:schema:wd-17\" CombinedDecision=\"false\" ReturnPolicyIdList=\"false\">\n" +
		                ...
		                "<Attribute AttributeId=\"urn:oasis:names:tc:xacml:1.0:subject:subjectMAC\" IncludeInResult=\"false\">\n" +
		                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#string\">" + subjectMAC +"</AttributeValue>\n" +
		                "</Attribute>\n" +

"</Attributes>\n" +

		                "<Attributes Category=\"urn:oasis:names:tc:xacml:1.0:subject-category:access-subject\">\n" +
		                "<Attribute AttributeId=\"urn:oasis:names:tc:xacml:1.0:subject:subjectMB\" IncludeInResult=\"false\">\n" +
		                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#string\">" + subjectMB +"</AttributeValue>\n" +
		                "</Attribute>\n" +

"</Attributes>\n" +

		                "<Attributes Category=\"urn:oasis:names:tc:xacml:1.0:subject-category:access-subject\">\n" +
		                "<Attribute AttributeId=\"urn:oasis:names:tc:xacml:1.0:subject:subjectCPU\" IncludeInResult=\"false\">\n" +
		                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#string\">" + subjectCPU +"</AttributeValue>\n" +
		                "</Attribute>\n" +
