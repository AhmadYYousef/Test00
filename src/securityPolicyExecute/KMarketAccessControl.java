...
public class KMarketAccessControl {
        ...
        */
        ...
        try {
            ...
            if(AbstractResult.DECISION_PERMIT == result.getDecision()){
                System.out.println("\n\"" + productName + "\" recommended \"OK\" to user \"" + userName + "\" \n\n");
            } else {
            	System.out.println("\n\"" + productName + "\" recommended \"NOT OK\"  to user \"" + userName + "\" \n\n");
 ...
 /*       return "<Request xmlns=\"urn:oasis:names:tc:xacml:3.0:core:schema:wd-17\" CombinedDecision=\"false\" ReturnPolicyIdList=\"false\">\n" +
                ...
                "<Attribute AttributeId=\"userLocationHome\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + 1 + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "<Attribute AttributeId=\"itemLocationHome\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + 1 + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "</Attributes>\n" +
                "<Attributes Category=\"http://kmarket.com/category\">\n" +
                "<Attribute AttributeId=\"userLocationCinema\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + 1 + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "<Attribute AttributeId=\"itemLocationCinema\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + 1 + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "</Attributes>\n" +                
                "</Request>";
        */
        ...
        return "<Request xmlns=\"urn:oasis:names:tc:xacml:3.0:core:schema:wd-17\" CombinedDecision=\"false\" ReturnPolicyIdList=\"false\">\n" +
                ...
                "<Attribute AttributeId=\"itemTimeWeekend\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "1" + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "<Attribute AttributeId=\"userTimeWeekend\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "1" + "</AttributeValue>\n" +
                "</Attribute>\n" +

                "<Attribute AttributeId=\"itemTimeWeekday\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "1" + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "<Attribute AttributeId=\"userTimeWeekday\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "0" + "</AttributeValue>\n" +
                "</Attribute>\n" +     
                ...
                "<Attribute AttributeId=\"itemCompanionAlone\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "1" + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "<Attribute AttributeId=\"userCompanionAlone\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "0" + "</AttributeValue>\n" +
                "</Attribute>\n" +

                "<Attribute AttributeId=\"itemCompanionFamily\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "1" + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "<Attribute AttributeId=\"userCompanionFamily\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "0" + "</AttributeValue>\n" +
                "</Attribute>\n" + 
                
                "<Attribute AttributeId=\"itemCompanionPartner\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "1" + "</AttributeValue>\n" +
                "</Attribute>\n" +
                "<Attribute AttributeId=\"userCompanionPartner\" IncludeInResult=\"false\">\n" +
                "<AttributeValue DataType=\"http://www.w3.org/2001/XMLSchema#integer\">" + "1" + "</AttributeValue>\n" +
                "</Attribute>\n" +                 
